...
export default class VideoInsertUI extends Plugin {
    ...
    _setUpDropdown(dropdownView: DropdownView, videoInsertView: VideoInsertPanelView, command: Command | undefined) {
        const editor = this.editor;
        const t = editor.t;
        ...
        dropdownView.on('change:isOpen', () => {
            ...
            if (dropdownView.isOpen) {
                ...
                if (videoUtils.isVideo(selectedElement)) {
                    videoInsertView.videoURLInputValue = String(selectedElement.getAttribute('src'));
