...
import { Video, VideoResize, VideoStyle, VideoToolbar, VideoUpload } from "@rahou0/ckeditor5-video";
...
Editor.defaultConfig = {
    // extraPlugins: [( editor: { plugins: { get: (arg0: string) => { (): any; new(): any; createUploadAdapter: (loader: any) => any; }; }; } ) => {
